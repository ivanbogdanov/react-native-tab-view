...
var requireNativeComponent = NativeModules.requireNativeComponent;
 ...
 * ```
 */
class CustomViewPagerAndroid extends React.Component {
  props: {
    initialPage?: number,
  ...
  componentDidMount() {
    ...
    console.log('YES!!!');
    this.refs[VIEWPAGER_REF].setNativeProps({overscrollMode:'none'})

    console.log('componentDidMount !!!')
//    const viewPager = Invoke.React.view(this.refs[VIEWPAGER_REF]);
//    const _getCount = Invoke.call(viewPager, 'getCount');
//    const c = await Invoke.execute(_getCount);
//    console.log('COUNT: ',c)
  }
...
var NativeAndroidViewPager = requireNativeComponent('AndroidViewPager', CustomViewPagerAndroid);

module.exports = CustomViewPagerAndroid;
